    ...
    <article className="container py-10 lg:py-16 max-w-4xl mx-auto">
      ...
      <div className="prose dark:prose-invert max-w-none space-y-12">
        ...
        <section>
          ...
          <ul>
            <li>
              <strong>디제잉 규칙 안내 모달 구현</strong>: 디제잉 등록 전 사용자에게 필수 규칙을 안내하는 모달을 구현하여 UX 흐름을 개선했습니다.
            </li>
            <li>
              <strong>로그인 페이지 개편</strong>: 기존 로그인 페이지의 UI/UX를 전면적으로 리뉴얼하여 사용자 접근성을 높였습니다.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            <li>
              <strong>실무 수준의 프론트엔드 환경 경험</strong>: 글로벌 사용자 대상의 Web3 플랫폼을 개발하며 다국어 지원(i18n), 디자인 시스템 구축(Storybook) 등 최신 개발 트렌드를 실전에서 익혔습니다.
            </li>
            <li>
              <strong>협업 커뮤니케이션 능력 향상</strong>: PM, 백엔드, 디자이너, 마케터 등 다양한 직군과의 긴밀한 협업을 통해 대규모 프로젝트의 워크플로우를 이해했습니다.
            </li>
            <li>
              <strong>UX 중심의 기능 구현</strong>: 단순한 기능 구현을 넘어, 사용자 경험(UX)을 고려한 모달 및 로그인 페이지 설계를 통해 서비스 품질을 높였습니다.
            </li>
            <li>
              <strong>코드 품질 및 유지보수</strong>: 실무 멘토링을 통해 유지보수 가능한 코드 작성법과 컴포넌트 설계 원칙을 학습하고 적용했습니다.
            </li>
          </ul>
        </section>
